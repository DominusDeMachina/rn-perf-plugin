...
## References
- Book: "The Ultimate Guide to React Native Optimization" (2026), "How to Profile Native Parts of React Native", pp. 96–101.
- Book: same title, "How to Hunt Memory Leaks", pp. 164–167.
- Book: same title, "Use View Flattening", p. 139.
