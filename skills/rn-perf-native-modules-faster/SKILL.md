...
- **Nitro Modules don't require Hermes specifically** — they're built on JSI (`jsi::NativeState`) and run in any JSI environment. They do require react-native 0.75+, and Nitro *views* require react-native 0.78+ and the New Architecture (Fabric).
