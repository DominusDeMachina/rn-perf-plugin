...
- Run the example SQL query — should return up to 20 rows ordered by duration.
...
## References
- Book: "The Ultimate Guide to React Native Optimization" (2026), "How to Profile Native Parts of React Native", p. 101.
