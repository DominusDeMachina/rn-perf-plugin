...
- `shrinkResources` **does not affect React Native image assets** — Metro packs those into `drawable-*-v4` folders (see [[rn-perf-native-assets-folder]]). R8's resource shrinker targets Android XML resources (layouts/strings/drawable XML).
